										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="baseDictionaryLevel.dict_item_name"/></TD>
													<TD><s:property value="baseDictionarySource.dict_item_name"/></TD>
													<TD><s:property value="baseDictionaryIndustry.dict_item_name"/></TD>
